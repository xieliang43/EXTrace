...
- (void)createTabBar
{
    ...
    btn0.tag = 100;
    btn0.frame = CGRectMake(0, 21, 64, 43);
    ...
    btn1.tag = 101;
    btn1.frame = CGRectMake(64, 21, 64, 43);
    ...
    btn2.tag = 102;
    btn2.frame = CGRectMake(128, 0, 64, 64);
    ...
    btn3.tag = 103;
    btn3.frame = CGRectMake(192, 21, 64, 43);
    ...
    btn4.tag = 104;
    btn4.frame = CGRectMake(256, 21, 64, 43);
